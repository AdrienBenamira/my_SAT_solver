                    ...
                    if self.is_sat:
                        ...
                        if self.tau == self.tau_ici:
                            ...
                            if compteur_sat2 in list(self.dico_res[self.tau_ici].keys()):
                                ...
                                namesat = "./data/Mini_GIFT_poubelle/" + str(tau) + "_" + str(compteur_sat) + "_dico_res_SAT.DIMACS"
                ...
                if flag_continue:
                    ...
                    if not sat_gen.is_sat:
                        ...
                        if new_key not in dico_res_unsat[tau].keys():
                            ...
                            namesat = "./data/Mini_GIFT_poubelle/" + str(tau) + "_" + str(cpteur) + "_dico_res_UNSAT.DIMACS"
