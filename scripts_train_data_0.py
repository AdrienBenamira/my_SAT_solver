...
for limit in ["3_5/", "7_10/", "12_15/"]:
    ...
    os.system(
        'python3 main.py --device ' + str(0) + ' --seed ' + str(seed) + ' --initialisation random --sparse No --sparseKL No --train_dir '+path1+
    ...
    os.system(
        'python3 main.py --device ' + str(0) + ' --seed ' + str(seed) + ' --initialisation random --sparse Yes --sparseKL No --l1weight 0.001 --train_dir '+path1+
        ' --test_dir '+path2+' --val_dir ' +path3)
